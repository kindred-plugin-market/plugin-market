...
> **形态**：bundled 插件（[D-024](https://github.com/indredK/bench/blob/HEAD/docs/explanation/decisions.md#d-024--extension-仓库组织与-photo-triage-试点拆法)，P2b 迁出）。
...
- 契约：[extension-spec.md](https://github.com/indredK/bench/blob/HEAD/docs/reference/extension-spec.md)；工作流：[extension-workflow.md](https://github.com/indredK/bench/blob/HEAD/docs/explanation/extension-workflow.md)
